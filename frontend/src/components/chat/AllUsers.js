...
export default function AllUsers({
  ...
  return (
    <>
      <ul className="overflow-auto h-[30rem] rounded">
        <h2 className="my-2 mb-2 ml-2 text-gray-900 dark:text-white">
          Active User{" "}
          <span style={{ backgroundColor: "blue", borderRadius: "15px", padding: "0 5px" }}>
            {chatRooms.length}
          </span>
        </h2>
        <li>
        ...
        <h2 className="my-5 mb-5 ml-5 text-gray-900 dark:text-white">
          Open Chat
        </h2>
        <li>
